...
subj = 'bwsdrdp6'
fixation_src_file = '../../../eyes/data_processing/data/' + subj  + '/' + subj + '_fixation_points_shuffle.mat'
...
inputs = ['radials_50_1', 'radials_50_2', 'radials_50_3', 'radials_50_4', 'radials_100_1']  # rerun the ones that were broken
