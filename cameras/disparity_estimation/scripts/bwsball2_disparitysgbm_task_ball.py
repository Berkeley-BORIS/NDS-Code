...
inputs = []
##MANUALLY SELECT RELEVANT FRAMES FROM EACH TASK IF NECESSARY
# FRAME SELECTION IS UNNECESSARY IF FRAMES OF INTEREST WERE
# MOVE TO THEIR OWN FOLDER
inputs.append(["task_ball",(0,0)])
