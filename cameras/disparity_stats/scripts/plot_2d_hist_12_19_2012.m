...
figure(); hold on; title([subj ' ' flag ' ' task ' vertical normed']);
...
figure(); hold on; title([subj ' ' flag ' ' task ' vertical unnormed']);
...
figure(); hold on; title([subj ' ' flag ' ' task ' horizontal normed']);
...
figure(); hold on; title([subj ' ' flag ' ' task ' horizontal unnormed']);
