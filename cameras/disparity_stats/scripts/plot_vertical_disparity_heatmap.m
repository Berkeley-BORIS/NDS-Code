bws_inside_walk_1 = load('../data/bwsdrdp6/bwsdrdp6_task_walk_1_vertical_disparity_stats.mat');
bws_inside_walk_2 = load('../data/bwsdrdp6/bwsdrdp6_task_walk_2_vertical_disparity_stats.mat');
bws_inside_walk_3 = load('../data/bwsdrdp6/bwsdrdp6_task_walk_3_vertical_disparity_stats.mat');
bws_nature_walk_1 = load('../data/bwsnat5/bwsnat5_task_nature_walk_1_vertical_disparity_stats.mat');
bws_nature_walk_2 = load('../data/bwsure1/bwsure1_task_nature_walk_2_vertical_disparity_stats.mat');
bws_campus_walk = load('../data/bwsnat5/bwsnat5_task_campus_walk_3_vertical_disparity_stats.mat');
bws_cafe = load('../data/bwscafe1/bwscafe1_task_ordering_coffee_vertical_disparity_stats.mat');
bws_sandwich = load('../data/bwssand1/bwssand1_task_sandwich_vertical_disparity_stats.mat');

% bws_inside_walk_1_ci = load('../data/bwsdrdp6/bwsdrdp6_task_walk_1_vertical_disparity_bootstrapped_ci.mat');
% bws_inside_walk_2_ci = load('../data/bwsdrdp6/bwsdrdp6_task_walk_2_vertical_disparity_bootstrapped_ci.mat');
% bws_inside_walk_3_ci = load('../data/bwsdrdp6/bwsdrdp6_task_walk_3_vertical_disparity_bootstrapped_ci.mat');
% bws_nature_walk_1_ci = load('../data/bwsnat5/bwsnat5_task_nature_walk_1_vertical_disparity_bootstrapped_ci.mat');
% bws_nature_walk_2_ci = load('../data/bwsure1/bwsure1_task_nature_walk_2_vertical_disparity_bootstrapped_ci.mat');
% bws_campus_walk_ci = load('../data/bwsnat5/bwsnat5_task_campus_walk_3_vertical_disparity_bootstrapped_ci.mat');
% bws_cafe_ci = load('../data/bwscafe1/bwscafe1_task_ordering_coffee_vertical_disparity_bootstrapped_ci.mat');
% bws_sandwich_ci = load('../data/bwssand1/bwssand1_task_sandwich_vertical_disparity_bootstrapped_ci.mat');

ges_inside_walk_1 = load('../data/gesdrdp1/gesdrdp1_task_walk_1_vertical_disparity_stats.mat');
ges_inside_walk_2 = load('../data/gesdrdp1/gesdrdp1_task_walk_2_vertical_disparity_stats.mat');
ges_inside_walk_3 = load('../data/gesdrdp1/gesdrdp1_task_walk_3_vertical_disparity_stats.mat');
ges_nature_walk_1 = load('../data/gesnat1/gesnat1_task_nature_walk_1_vertical_disparity_stats.mat');
ges_nature_walk_2 = load('../data/gesure1/gesure1_task_nature_walk_2_vertical_disparity_stats.mat');
ges_campus_walk = load('../data/gesnat1/gesnat1_task_campus_walk_3_vertical_disparity_stats.mat');
ges_cafe = load('../data/gescafe2/gescafe2_task_ordering_coffee_vertical_disparity_stats.mat');
ges_sandwich = load('../data/gessand1/gessand1_task_sandwich_vertical_disparity_stats.mat');

% ges_inside_walk_1_ci = load('../data/gesdrdp1/gesdrdp1_task_walk_1_vertical_disparity_bootstrapped_ci.mat');
% ges_inside_walk_2_ci = load('../data/gesdrdp1/gesdrdp1_task_walk_2_vertical_disparity_bootstrapped_ci.mat');
% ges_inside_walk_3_ci = load('../data/gesdrdp1/gesdrdp1_task_walk_3_vertical_disparity_bootstrapped_ci.mat');
% ges_nature_walk_1_ci = load('../data/gesnat1/gesnat1_task_nature_walk_1_vertical_disparity_bootstrapped_ci.mat');
% ges_nature_walk_2_ci = load('../data/gesure1/gesure1_task_nature_walk_2_vertical_disparity_bootstrapped_ci.mat');
% ges_campus_walk_ci = load('../data/gesnat1/gesnat1_task_campus_walk_3_vertical_disparity_bootstrapped_ci.mat');
% ges_cafe_ci = load('../data/gescafe2/gescafe2_task_ordering_coffee_vertical_disparity_bootstrapped_ci.mat');
% ges_sandwich_ci = load('../data/gessand1/gessand1_task_sandwich_vertical_disparity_bootstrapped_ci.mat');

hmf_inside_walk_1 = load('../data/hmfdrdp1/hmfdrdp1_task_walk_1_vertical_disparity_stats.mat');
hmf_inside_walk_2 = load('../data/hmfdrdp1/hmfdrdp1_task_walk_2_vertical_disparity_stats.mat');
hmf_inside_walk_3 = load('../data/hmfdrdp1/hmfdrdp1_task_walk_3_vertical_disparity_stats.mat');
hmf_nature_walk_1 = load('../data/hmfnat1/hmfnat1_task_nature_walk_1_vertical_disparity_stats.mat');
hmf_nature_walk_2 = load('../data/hmfure1/hmfure1_task_nature_walk_2_vertical_disparity_stats.mat');
hmf_campus_walk = load('../data/hmfnat1/hmfnat1_task_campus_walk_3_vertical_disparity_stats.mat');
hmf_cafe = load('../data/hmfcafe1/hmfcafe1_task_ordering_coffee_vertical_disparity_stats.mat');

% hmf_nature_walk_1_ci = load('../data/hmfnat1/hmfnat1_task_nature_walk_1_vertical_disparity_bootstrapped_ci.mat');
% hmf_campus_walk_ci = load('../data/hmfnat1/hmfnat1_task_campus_walk_3_vertical_disparity_bootstrapped_ci.mat');
